...
// ReSharper restore CheckNamespace
{
    ...
    public static class MetroGridHelper
    {
        ...
        private static double _opacity = 0.10;
        private static Color _color = Colors.Blue;
        private static List<Rectangle> _squares;
        private static Grid _grid;

        /// <summary>
        ///   Gets or sets a value indicating whether the designer grid is visible on top of the application's frame.
        /// </summary>
